...
public class ServerHandler extends SimpleChannelInboundHandler<Message> {
    ...
    public void channelRead0(ChannelHandlerContext ctx, Message msg) {
        ...
        if (handler != null) {
            ...
            try {
                ...
                if (rep != null) {
                    log.info(
                            "Sending response: {} to {}", rep.getClass().getSimpleName(), channel.remoteAddress());
    ...
    public void channelWritabilityChanged(ChannelHandlerContext ctx) {
        log.info(
                "Channel writability changed: {} isWritable: {}", ctx.channel().remoteAddress(), ctx.channel().isWritable());
    }
    ...
    public void userEventTriggered(ChannelHandlerContext ctx, Object evt) {
        log.info(
                "User event triggered: {} event: {}", ctx.channel().remoteAddress(), evt.getClass().getSimpleName());
    }
}
