...
import org.markeb.net.NetworkAutoConfiguration;
...
import org.markeb.game.NodeApplication;
                    ...
                    protected void initChannel(Channel ch) {
                        ...
                        ch.pipeline().addLast(new SimpleChannelInboundHandler<Message>() {
                            ...
                            public void channelActive(ChannelHandlerContext ctx) {
                                org.markeb.proto.message.Test.ReqTestMessage testMessage = org.markeb.proto.message.Test.ReqTestMessage.newBuilder()
                                    .setId(1)
                                    .setName("Test")
                                    .build();
                                try {
