...
public class ProtoBuffParser implements IGameParser<Message> {
    ...
    public void register(
                         int id, Class<? extends Message> messageClazz, Parser<? extends Message> parser) {
    ...
    private int findMsgIdFromClass(Class<? extends Message> messageClazz) {
        try {
            ...
            throw new IllegalArgumentException(
                    MSG_ID_OPTION + " option not found in " + messageClazz.getName());
        } catch (Exception e) {
            throw new RuntimeException(
                    "Failed to parse " + MSG_ID_OPTION + ": " + messageClazz.getName(), e);
        }
    }
