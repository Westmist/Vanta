...
public class ProtoBuffGameMessagePool implements IMessagePool<Message> {
  ...
  private static final Map<Integer, IContextHandle<? extends GameActorContext, Message>>
  ...
  public void register(
      int msgId, IContextHandle<? extends GameActorContext, Message> contextHandle) {
